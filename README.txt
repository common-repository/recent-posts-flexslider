...
= 2.4.1 - 11 July 2021 =
* fixes widget setting styling for new widget block editor in WP v5.8.0

= 2.4.0 - 6 December 2020 =
* Updates to Flexslider v2.7.2
* Updates Flexslider default styling

= 2.3.0 - 16 August 2020 =
* Adds option to specify post content, post excerpt, or none. Props @kaquna
